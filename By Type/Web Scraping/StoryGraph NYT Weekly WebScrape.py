...
storygraph_links = pd.read_csv(r"/Users/coramcanulty/Desktop/Stacy NYT python proj./storygraph_links_weekly1523_morethan one_CSV.csv")
#print(NYT_bestsellers)

urls = list(storygraph_links.get("links"))
...
titles_and_tags_table.to_csv(r'NYT_MG_WEEKLY_1523_TAGSstorygraph_CSV.csv')
