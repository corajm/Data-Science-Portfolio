...
counts_pd = pd.read_csv(r"/Users/coramcanulty/Desktop/Stacy NYT python proj./csv/counts_weekly1523_CSV.csv")
#print(counts_pd)

counts_list = list(counts_pd.get("0"))
#print(counts_list)

tags_01_pd = pd.read_csv(r"/Users/coramcanulty/Desktop/Stacy NYT python proj./csv/tags weekly/NYT_MG_WEEKLY_1523_TAGS_CSV_01.csv")
#print(tags_01_pd)
tags_02_pd = pd.read_csv(r"/Users/coramcanulty/Desktop/Stacy NYT python proj./csv/tags weekly/NYT_MG_WEEKLY_1523_TAGS_CSV_02.csv")
#print(tags_02_pd)
tags_03_pd = pd.read_csv(r"/Users/coramcanulty/Desktop/Stacy NYT python proj./csv/tags weekly/NYT_MG_WEEKLY_1523_TAGS_CSV_03.csv")
#print(tags_01_pd)
...
titles_half = list(set(titles_01_list) | set(titles_02_list))
...
tags_01_list = list(tags_01_pd.iloc[:,1])
#print(tags_01_list)
...
#tags_and_counts.to_csv(r'tag_counts_weekly1523_CSV.csv')
...
total_count_series.to_csv(r'total_tag_count_weekly1523_CSV.csv')
