...
Links_csv = pd.read_csv(r"/Users/coramcanulty/Desktop/Stacy NYT python proj./All_MG_missing_81.csv")
...
for url in urls:
    ...
    if soup:
        search3 = soup.find(class_="a-button-inner")
        print(search3)
        if search:
            if search2:
...
amazon_export.to_csv(r'All_MG_Ama_81.csv')
missing_export.to_csv(r'All_MG_missing_81.csv')